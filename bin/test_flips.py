...
def run(args):
    ...
    for i, image in enumerate(images):
        ...
        logging.info('Flip %d loss : flows mse (%10.6g, %10.6g); p bce %10.6g; p softmargin %10.6g; p IoU %10.6g',
                     0, 0, 0, loss_p, loss_p2, 1)
        ...
        for k in range(1, 4):
            ...
            iou = jaccard(pp, rp)
            logging.info('Flip %d loss : flows mse (%10.6g, %10.6g); p bce %10.6g; p softmargin %10.6g; p IoU %10.6g',
                         k, loss_vflow, loss_hflow, loss_p, loss_p2, iou)
            del yy
        del X
        del y
